...
void Module_dasIMGUI::initFunctions_27() {
	...
	using _method_156 = das::das_call_member< void (ImFont::*)(ImDrawList *,float,ImVec2,ImU32,ImWchar) const,&ImFont::RenderChar >;
	addExtern<DAS_CALL_METHOD(_method_156)>(*this,lib,"RenderChar",SideEffects::worstDefault,"das_call_member< void (ImFont::*)(ImDrawList *,float,ImVec2,ImU32,ImWchar) const , &ImFont::RenderChar >::invoke")
		->args({"self","draw_list","size","pos","col","c"});
	using _method_157 = das::das_call_member< void (ImFont::*)(ImDrawList *,float,ImVec2,ImU32,const ImVec4 &,const char *,const char *,float,bool) const,&ImFont::RenderText >;
	addExtern<DAS_CALL_METHOD(_method_157)>(*this,lib,"RenderText",SideEffects::worstDefault,"das_call_member< void (ImFont::*)(ImDrawList *,float,ImVec2,ImU32,const ImVec4 &,const char *,const char *,float,bool) const , &ImFont::RenderText >::invoke")
	...
	addExtern<DAS_CALL_METHOD(_method_160)>(*this,lib,"GrowIndex",SideEffects::worstDefault,"das_call_member< void (ImFont::*)(int) , &ImFont::GrowIndex >::invoke")
		->args({"self","new_size"});
	using _method_161 = das::das_call_member< void (ImFont::*)(const ImFontConfig *,ImWchar,float,float,float,float,float,float,float,float,float),&ImFont::AddGlyph >;
	addExtern<DAS_CALL_METHOD(_method_161)>(*this,lib,"AddGlyph",SideEffects::worstDefault,"das_call_member< void (ImFont::*)(const ImFontConfig *,ImWchar,float,float,float,float,float,float,float,float,float) , &ImFont::AddGlyph >::invoke")
		->args({"self","src_cfg","c","x0","y0","x1","y1","u0","v0","u1","v1","advance_x"});
	using _method_162 = das::das_call_member< void (ImFont::*)(ImWchar,ImWchar,bool),&ImFont::AddRemapChar >;
	addExtern<DAS_CALL_METHOD(_method_162)>(*this,lib,"AddRemapChar",SideEffects::worstDefault,"das_call_member< void (ImFont::*)(ImWchar,ImWchar,bool) , &ImFont::AddRemapChar >::invoke")
		->args({"self","dst","src","overwrite_dst"})
		->arg_init(3,make_smart<ExprConstBool>(true));
	using _method_163 = das::das_call_member< void (ImFont::*)(ImWchar,bool),&ImFont::SetGlyphVisible >;
	addExtern<DAS_CALL_METHOD(_method_163)>(*this,lib,"SetGlyphVisible",SideEffects::worstDefault,"das_call_member< void (ImFont::*)(ImWchar,bool) , &ImFont::SetGlyphVisible >::invoke")
		->args({"self","c","visible"});
	using _method_164 = das::das_call_member< void (ImFont::*)(ImWchar),&ImFont::SetFallbackChar >;
	addExtern<DAS_CALL_METHOD(_method_164)>(*this,lib,"SetFallbackChar",SideEffects::worstDefault,"das_call_member< void (ImFont::*)(ImWchar) , &ImFont::SetFallbackChar >::invoke")
		->args({"self","c"});
