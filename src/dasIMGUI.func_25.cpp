...
void Module_dasIMGUI::initFunctions_25() {
	using _method_116 = das::das_call_member< void (ImFontGlyphRangesBuilder::*)(ImWchar),&ImFontGlyphRangesBuilder::AddChar >;
	addExtern<DAS_CALL_METHOD(_method_116)>(*this,lib,"AddChar",SideEffects::worstDefault,"das_call_member< void (ImFontGlyphRangesBuilder::*)(ImWchar) , &ImFontGlyphRangesBuilder::AddChar >::invoke")
		->args({"self","c"});
	...
	using _method_118 = das::das_call_member< void (ImFontGlyphRangesBuilder::*)(const ImWchar *),&ImFontGlyphRangesBuilder::AddRanges >;
	addExtern<DAS_CALL_METHOD(_method_118)>(*this,lib,"AddRanges",SideEffects::worstDefault,"das_call_member< void (ImFontGlyphRangesBuilder::*)(const ImWchar *) , &ImFontGlyphRangesBuilder::AddRanges >::invoke")
		->args({"self","ranges"});
	using _method_119 = das::das_call_member< void (ImFontGlyphRangesBuilder::*)(ImVector<ImWchar> *),&ImFontGlyphRangesBuilder::BuildRanges >;
	addExtern<DAS_CALL_METHOD(_method_119)>(*this,lib,"BuildRanges",SideEffects::worstDefault,"das_call_member< void (ImFontGlyphRangesBuilder::*)(ImVector<ImWchar> *) , &ImFontGlyphRangesBuilder::BuildRanges >::invoke")
	...
	using _method_123 = das::das_call_member< ImFont * (ImFontAtlas::*)(const char *,float,const ImFontConfig *,const ImWchar *),&ImFontAtlas::AddFontFromFileTTF >;
	addExtern<DAS_CALL_METHOD(_method_123)>(*this,lib,"AddFontFromFileTTF",SideEffects::worstDefault,"das_call_member< ImFont * (ImFontAtlas::*)(const char *,float,const ImFontConfig *,const ImWchar *) , &ImFontAtlas::AddFontFromFileTTF >::invoke")
		->args({"self","filename","size_pixels","font_cfg","glyph_ranges"})
		->arg_init(3,make_smart<ExprConstPtr>())
		->arg_init(4,make_smart<ExprConstPtr>());
	using _method_124 = das::das_call_member< ImFont * (ImFontAtlas::*)(void *,int,float,const ImFontConfig *,const ImWchar *),&ImFontAtlas::AddFontFromMemoryTTF >;
	addExtern<DAS_CALL_METHOD(_method_124)>(*this,lib,"AddFontFromMemoryTTF",SideEffects::worstDefault,"das_call_member< ImFont * (ImFontAtlas::*)(void *,int,float,const ImFontConfig *,const ImWchar *) , &ImFontAtlas::AddFontFromMemoryTTF >::invoke")
		->args({"self","font_data","font_size","size_pixels","font_cfg","glyph_ranges"})
		->arg_init(4,make_smart<ExprConstPtr>())
		->arg_init(5,make_smart<ExprConstPtr>());
	using _method_125 = das::das_call_member< ImFont * (ImFontAtlas::*)(const void *,int,float,const ImFontConfig *,const ImWchar *),&ImFontAtlas::AddFontFromMemoryCompressedTTF >;
	addExtern<DAS_CALL_METHOD(_method_125)>(*this,lib,"AddFontFromMemoryCompressedTTF",SideEffects::worstDefault,"das_call_member< ImFont * (ImFontAtlas::*)(const void *,int,float,const ImFontConfig *,const ImWchar *) , &ImFontAtlas::AddFontFromMemoryCompressedTTF >::invoke")
		->args({"self","compressed_font_data","compressed_font_size","size_pixels","font_cfg","glyph_ranges"})
		->arg_init(4,make_smart<ExprConstPtr>())
		->arg_init(5,make_smart<ExprConstPtr>());
	using _method_126 = das::das_call_member< ImFont * (ImFontAtlas::*)(const char *,float,const ImFontConfig *,const ImWchar *),&ImFontAtlas::AddFontFromMemoryCompressedBase85TTF >;
	addExtern<DAS_CALL_METHOD(_method_126)>(*this,lib,"AddFontFromMemoryCompressedBase85TTF",SideEffects::worstDefault,"das_call_member< ImFont * (ImFontAtlas::*)(const char *,float,const ImFontConfig *,const ImWchar *) , &ImFontAtlas::AddFontFromMemoryCompressedBase85TTF >::invoke")
