...
void Module_dasIMGUI::initFunctions_14() {
	...
	addExtern<void (*)(const char *,char *),ImGui::LogTextV>(*this,lib,"LogTextV",SideEffects::worstDefault,"ImGui::LogTextV")
		->args({"fmt","args"});
	...
	addExtern<bool (*)(const char *,const void *,unsigned long long,int),ImGui::SetDragDropPayload>(*this,lib,"SetDragDropPayload",SideEffects::worstDefault,"ImGui::SetDragDropPayload")
