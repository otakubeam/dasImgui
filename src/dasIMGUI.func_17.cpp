...
void Module_dasIMGUI::initFunctions_17() {
	...
	addExtern<void (*)(const char *),ImGui::LoadIniSettingsFromDisk>(*this,lib,"LoadIniSettingsFromDisk",SideEffects::worstDefault,"ImGui::LoadIniSettingsFromDisk")
		->args({"ini_filename"});
	addExtern<void (*)(const char *,unsigned long long),ImGui::LoadIniSettingsFromMemory>(*this,lib,"LoadIniSettingsFromMemory",SideEffects::worstDefault,"ImGui::LoadIniSettingsFromMemory")
