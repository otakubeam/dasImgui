...
void Module_dasIMGUI_NODE_EDITOR::initFunctions_1() {
	addExtern<ax::NodeEditor::SaveReasonFlags (*)(ax::NodeEditor::SaveReasonFlags,ax::NodeEditor::SaveReasonFlags),ax::NodeEditor::operator|>(*this,lib,"|",SideEffects::worstDefault,"ax::NodeEditor::operator|")
		->args({"lhs","rhs"});
	addExtern<ax::NodeEditor::SaveReasonFlags (*)(ax::NodeEditor::SaveReasonFlags,ax::NodeEditor::SaveReasonFlags),ax::NodeEditor::operator&>(*this,lib,"&",SideEffects::worstDefault,"ax::NodeEditor::operator&")
		->args({"lhs","rhs"});
