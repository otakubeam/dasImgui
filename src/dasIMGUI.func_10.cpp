...
void Module_dasIMGUI::initFunctions_10() {
	addExtern< bool (*)(const char *,ImGuiDataType,void *,int,const void *,const void *,const char *,ImGuiInputTextFlags) , ImGui::InputScalarN >(*this,lib,"InputScalarN",SideEffects::worstDefault,"ImGui::InputScalarN")
	...
	addExtern< bool (*)(const char *,float [3],ImGuiColorEditFlags) , ImGui::ColorEdit3 >(*this,lib,"ColorEdit3",SideEffects::worstDefault,"ImGui::ColorEdit3")
	...
	addExtern< bool (*)(const char *,float [4],ImGuiColorEditFlags) , ImGui::ColorEdit4 >(*this,lib,"ColorEdit4",SideEffects::worstDefault,"ImGui::ColorEdit4")
		->args({"label","col","flags"})
		->arg_type(2,makeType<ImGuiColorEditFlags_>(lib))
		->arg_init(2,make_smart<ExprConstEnumeration>(0,makeType<ImGuiColorEditFlags_>(lib)));
	addExtern< bool (*)(const char *,float [3],ImGuiColorEditFlags) , ImGui::ColorPicker3 >(*this,lib,"ColorPicker3",SideEffects::worstDefault,"ImGui::ColorPicker3")
		->args({"label","col","flags"})
		->arg_type(2,makeType<ImGuiColorEditFlags_>(lib))
		->arg_init(2,make_smart<ExprConstEnumeration>(0,makeType<ImGuiColorEditFlags_>(lib)));
	addExtern< bool (*)(const char *,float [4],ImGuiColorEditFlags,const float *) , ImGui::ColorPicker4 >(*this,lib,"ColorPicker4",SideEffects::worstDefault,"ImGui::ColorPicker4")
		->args({"label","col","flags","ref_col"})
		->arg_type(2,makeType<ImGuiColorEditFlags_>(lib))
		->arg_init(2,make_smart<ExprConstEnumeration>(0,makeType<ImGuiColorEditFlags_>(lib)))
		->arg_init(3,make_smart<ExprConstPtr>());
	addExtern< bool (*)(const char *,const ImVec4 &,ImGuiColorEditFlags,ImVec2) , ImGui::ColorButton >(*this,lib,"ColorButton",SideEffects::worstDefault,"ImGui::ColorButton")
		->args({"desc_id","col","flags","size"})
		->arg_type(2,makeType<ImGuiColorEditFlags_>(lib))
		->arg_init(2,make_smart<ExprConstEnumeration>(0,makeType<ImGuiColorEditFlags_>(lib)));
	addExtern< void (*)(ImGuiColorEditFlags) , ImGui::SetColorEditOptions >(*this,lib,"SetColorEditOptions",SideEffects::worstDefault,"ImGui::SetColorEditOptions")
		->args({"flags"})
	...
	addExtern< void (*)(bool,ImGuiCond) , ImGui::SetNextItemOpen >(*this,lib,"SetNextItemOpen",SideEffects::worstDefault,"ImGui::SetNextItemOpen")
		->args({"is_open","cond"})
