...
void Module_dasIMGUI::initFunctions_19() {
	...
	addExtern<DAS_CALL_METHOD(_method_27)>(*this,lib,"c_str",SideEffects::worstDefault,"das_call_member< const char * (ImGuiTextBuffer::*)() const,&ImGuiTextBuffer::c_str >::invoke")
		->args({"self"});
	using _method_28 = das::das_call_member< void (ImGuiTextBuffer::*)(const char *,char *),&ImGuiTextBuffer::appendfv >;
	addExtern<DAS_CALL_METHOD(_method_28)>(*this,lib,"appendfv",SideEffects::worstDefault,"das_call_member< void (ImGuiTextBuffer::*)(const char *,char *),&ImGuiTextBuffer::appendfv >::invoke")
		->args({"self","fmt","args"});
	...
	addExtern<DAS_CALL_METHOD(_method_29)>(*this,lib,"Clear",SideEffects::worstDefault,"das_call_member< void (ImGuiStorage::*)(),&ImGuiStorage::Clear >::invoke")
		->args({"self"});
	using _method_30 = das::das_call_member< int (ImGuiStorage::*)(unsigned int,int) const,&ImGuiStorage::GetInt >;
	addExtern<DAS_CALL_METHOD(_method_30)>(*this,lib,"GetInt",SideEffects::worstDefault,"das_call_member< int (ImGuiStorage::*)(unsigned int,int) const,&ImGuiStorage::GetInt >::invoke")
		->args({"self","key","default_val"})
		->arg_init(2,make_smart<ExprConstInt>(0));
	using _method_31 = das::das_call_member< void (ImGuiStorage::*)(unsigned int,int),&ImGuiStorage::SetInt >;
	addExtern<DAS_CALL_METHOD(_method_31)>(*this,lib,"SetInt",SideEffects::worstDefault,"das_call_member< void (ImGuiStorage::*)(unsigned int,int),&ImGuiStorage::SetInt >::invoke")
		->args({"self","key","val"});
	using _method_32 = das::das_call_member< bool (ImGuiStorage::*)(unsigned int,bool) const,&ImGuiStorage::GetBool >;
	addExtern<DAS_CALL_METHOD(_method_32)>(*this,lib,"GetBool",SideEffects::worstDefault,"das_call_member< bool (ImGuiStorage::*)(unsigned int,bool) const,&ImGuiStorage::GetBool >::invoke")
		->args({"self","key","default_val"})
		->arg_init(2,make_smart<ExprConstBool>(false));
	using _method_33 = das::das_call_member< void (ImGuiStorage::*)(unsigned int,bool),&ImGuiStorage::SetBool >;
	addExtern<DAS_CALL_METHOD(_method_33)>(*this,lib,"SetBool",SideEffects::worstDefault,"das_call_member< void (ImGuiStorage::*)(unsigned int,bool),&ImGuiStorage::SetBool >::invoke")
		->args({"self","key","val"});
	using _method_34 = das::das_call_member< float (ImGuiStorage::*)(unsigned int,float) const,&ImGuiStorage::GetFloat >;
	addExtern<DAS_CALL_METHOD(_method_34)>(*this,lib,"GetFloat",SideEffects::worstDefault,"das_call_member< float (ImGuiStorage::*)(unsigned int,float) const,&ImGuiStorage::GetFloat >::invoke")
		->args({"self","key","default_val"})
