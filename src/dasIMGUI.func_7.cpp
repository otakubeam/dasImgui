...
void Module_dasIMGUI::initFunctions_7() {
	addExtern<unsigned int (*)(const void *),ImGui::GetID>(*this,lib,"GetID",SideEffects::worstDefault,"ImGui::GetID")
		->args({"ptr_id"});
	addExtern<void (*)(const char *,char *),ImGui::TextV>(*this,lib,"TextV",SideEffects::worstDefault,"ImGui::TextV")
		->args({"fmt","args"});
	addExtern<void (*)(const ImVec4 &,const char *,char *),ImGui::TextColoredV>(*this,lib,"TextColoredV",SideEffects::worstDefault,"ImGui::TextColoredV")
		->args({"col","fmt","args"});
	addExtern<void (*)(const char *,char *),ImGui::TextDisabledV>(*this,lib,"TextDisabledV",SideEffects::worstDefault,"ImGui::TextDisabledV")
		->args({"fmt","args"});
	addExtern<void (*)(const char *,char *),ImGui::TextWrappedV>(*this,lib,"TextWrappedV",SideEffects::worstDefault,"ImGui::TextWrappedV")
		->args({"fmt","args"});
	addExtern<void (*)(const char *,const char *,char *),ImGui::LabelTextV>(*this,lib,"LabelTextV",SideEffects::worstDefault,"ImGui::LabelTextV")
		->args({"label","fmt","args"});
	addExtern<void (*)(const char *,char *),ImGui::BulletTextV>(*this,lib,"BulletTextV",SideEffects::worstDefault,"ImGui::BulletTextV")
		->args({"fmt","args"});
