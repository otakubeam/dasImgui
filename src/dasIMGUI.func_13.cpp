...
void Module_dasIMGUI::initFunctions_13() {
	...
	addExtern< ImGuiTableColumnFlags (*)(int) , ImGui::TableGetColumnFlags >(*this,lib,"TableGetColumnFlags",SideEffects::worstDefault,"ImGui::TableGetColumnFlags")
		->args({"column_n"})
		->arg_init(0,make_smart<ExprConstInt>(-1))
		->res_type(makeType<ImGuiTableColumnFlags_>(lib));
	addExtern< void (*)(ImGuiTableBgTarget,ImU32,int) , ImGui::TableSetBgColor >(*this,lib,"TableSetBgColor",SideEffects::worstDefault,"ImGui::TableSetBgColor")
	...
	addExtern< bool (*)(const char *,ImGuiTabBarFlags) , ImGui::BeginTabBar >(*this,lib,"BeginTabBar",SideEffects::worstDefault,"ImGui::BeginTabBar")
		->args({"str_id","flags"})
	...
	addExtern< bool (*)(const char *,bool *,ImGuiTabItemFlags) , ImGui::BeginTabItem >(*this,lib,"BeginTabItem",SideEffects::worstDefault,"ImGui::BeginTabItem")
