...
void Module_dasIMGUI::initFunctions_23() {
	using _method_95 = das::das_call_member< void (ImDrawList::*)(const ImVec2 &,const ImVec2 &,unsigned int),&ImDrawList::PrimRect >;
	addExtern<DAS_CALL_METHOD(_method_95)>(*this,lib,"PrimRect",SideEffects::worstDefault,"das_call_member< void (ImDrawList::*)(const ImVec2 &,const ImVec2 &,unsigned int),&ImDrawList::PrimRect >::invoke")
		->args({"self","a","b","col"});
	using _method_96 = das::das_call_member< void (ImDrawList::*)(const ImVec2 &,const ImVec2 &,const ImVec2 &,const ImVec2 &,unsigned int),&ImDrawList::PrimRectUV >;
	addExtern<DAS_CALL_METHOD(_method_96)>(*this,lib,"PrimRectUV",SideEffects::worstDefault,"das_call_member< void (ImDrawList::*)(const ImVec2 &,const ImVec2 &,const ImVec2 &,const ImVec2 &,unsigned int),&ImDrawList::PrimRectUV >::invoke")
		->args({"self","a","b","uv_a","uv_b","col"});
	using _method_97 = das::das_call_member< void (ImDrawList::*)(const ImVec2 &,const ImVec2 &,const ImVec2 &,const ImVec2 &,const ImVec2 &,const ImVec2 &,const ImVec2 &,const ImVec2 &,unsigned int),&ImDrawList::PrimQuadUV >;
	addExtern<DAS_CALL_METHOD(_method_97)>(*this,lib,"PrimQuadUV",SideEffects::worstDefault,"das_call_member< void (ImDrawList::*)(const ImVec2 &,const ImVec2 &,const ImVec2 &,const ImVec2 &,const ImVec2 &,const ImVec2 &,const ImVec2 &,const ImVec2 &,unsigned int),&ImDrawList::PrimQuadUV >::invoke")
		->args({"self","a","b","c","d","uv_a","uv_b","uv_c","uv_d","col"});
	using _method_98 = das::das_call_member< void (ImDrawList::*)(const ImVec2 &,const ImVec2 &,unsigned int),&ImDrawList::PrimWriteVtx >;
	addExtern<DAS_CALL_METHOD(_method_98)>(*this,lib,"PrimWriteVtx",SideEffects::worstDefault,"das_call_member< void (ImDrawList::*)(const ImVec2 &,const ImVec2 &,unsigned int),&ImDrawList::PrimWriteVtx >::invoke")
	...
	addExtern<DAS_CALL_METHOD(_method_99)>(*this,lib,"PrimWriteIdx",SideEffects::worstDefault,"das_call_member< void (ImDrawList::*)(unsigned int),&ImDrawList::PrimWriteIdx >::invoke")
		->args({"self","idx"});
	using _method_100 = das::das_call_member< void (ImDrawList::*)(const ImVec2 &,const ImVec2 &,unsigned int),&ImDrawList::PrimVtx >;
	addExtern<DAS_CALL_METHOD(_method_100)>(*this,lib,"PrimVtx",SideEffects::worstDefault,"das_call_member< void (ImDrawList::*)(const ImVec2 &,const ImVec2 &,unsigned int),&ImDrawList::PrimVtx >::invoke")
		->args({"self","pos","uv","col"});
	...
	addExtern<DAS_CALL_METHOD(_method_113)>(*this,lib,"Clear",SideEffects::worstDefault,"das_call_member< void (ImFontGlyphRangesBuilder::*)(),&ImFontGlyphRangesBuilder::Clear >::invoke")
		->args({"self"});
	using _method_114 = das::das_call_member< bool (ImFontGlyphRangesBuilder::*)(unsigned long long) const,&ImFontGlyphRangesBuilder::GetBit >;
	addExtern<DAS_CALL_METHOD(_method_114)>(*this,lib,"GetBit",SideEffects::worstDefault,"das_call_member< bool (ImFontGlyphRangesBuilder::*)(unsigned long long) const,&ImFontGlyphRangesBuilder::GetBit >::invoke")
		->args({"self","n"});
}
}
